...
my $fileIDq = '1rex_bound';
my $fileIDr = '1rex_unbound';
my $fileIDl = '1rex_ligand';
my $forceID = '';
my $dforceID = '';
my $runsID = '1';
my $implicit=0;
...
### write control file
open(my $ctlFile1, '>', "MDq_$fileIDq.ctl") or die "Could not open output file";
print $ctlFile1 
...
print "creating PDB file for $fileIDq\n\n";
open(PDB, ">"."create-pdb$fileIDq.cpptraj");
print PDB "parm wat_$fileIDq"."REDUCED.prmtop\n";
print PDB "trajin prod_$fileIDq"."REDUCED_0.nc lastframe\n";
print PDB "autoimage\n";
print PDB "rms fit :1-306\n";
print PDB "strip :WAT\n";
print PDB "strip :Na+,Cl-\n";
print PDB "trajout pdb_mutants_final/final_$fileIDq.pdb pdb\n";
print PDB "run\n";
close PDB;
system "cpptraj -i create-pdb$fileIDq.cpptraj\n";
